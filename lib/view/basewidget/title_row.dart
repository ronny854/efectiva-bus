...
class TitleRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [
      Text(title, style: robotoBold.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE)),
      eventDuration == null
      ...
      child: Center(
        child: Text(time < 10 ? '0$time' : time.toString(),
          style: robotoBold.copyWith(
            color: isBorder ? ColorResources.getPrimary(context) : Theme.of(context).colorScheme.secondary,
