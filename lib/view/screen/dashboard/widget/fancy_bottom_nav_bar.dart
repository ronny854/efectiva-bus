...
class FancyBottomNavBarState extends State<FancyBottomNavBar>
  ...
  IconData nextImage = Icons.dashboard_outlined;
  IconData activeImage = Icons.dashboard_outlined;
  ...
  void didChangeDependencies() {
    ...
    activeImage = widget.tabs[currentSelected].iconPath;
  ...
  _setSelected(UniqueKey key) {
    ...
    if (mounted) {
      setState(() {
        ...
        nextImage = widget.tabs[selected].iconPath;
      });
    }
  }
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: AnimatedOpacity(
                                ...
                                //   child: Icon(activeImage, size:40),
                                //   // child: Image.asset(
                                //   //   activeImage,
                                //   //   color: activeIconColor,
                                //   // ),
...
class FancyTabData {
  FancyTabData({@required this.iconPath, @required this.title, this.onclick});
