          ...
          children: [
            ...
            Expanded(
              child: ListView(padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL), children: [
                ...
                Text(getTranslated('enter_email_for_password_reset', context), style: robotoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.FONT_SIZE_LARGE)),
