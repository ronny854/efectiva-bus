...
import 'package:activa_efectiva_bus/view/basewidget/show_custom_snakbar.dart';
...
class _AddTicketScreenState extends State<AddTicketScreen> {
  ...
  Widget build(BuildContext context) {
    return CustomExpandedAppBar(
      ...
      Text(getTranslated('add_new_ticket', context), style: robotoBold.copyWith(fontSize: 20)),
